 ...
 */
public class YouGou extends Fragment implements Init {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_yougou, container, false);
        InitViews();
        InitEvents();
        return view;
    }
    ...
    public void InitViews() {
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.swipe_layout_yougou);
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerview_yougou);
    }
    ...
    private void getImages() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                connectedImp.getImageALL(Url.HOST_YOUGOU + mPages, new ResultListener() {
                    @Override
