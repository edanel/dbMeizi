 ...
 */
public class MeiTun extends Fragment implements Init {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_meitun, container, false);
        InitViews();
        InitEvents();
        return view;
    }
    ...
    public void InitViews() {
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.swipe_layout_meitun);
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerview_meitun);
    }
    ...
    private void getImages() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                connectedImp.getImageALL(Url.HOST_MEITUN + mPages, new ResultListener() {
                    @Override
